    ...
    <>
      <div className="container-fluid page-header py-5">
        ...
        <ol className="breadcrumb justify-content-center mb-0">
          <Link sat to="/" className="breadcrumb-item display-7">
            <a href="#">Home</a>
          </Link>
          <li className="breadcrumb-item active display-7 text-white">Cart</li>
        </ol>
      </div>
                ...
                <tbody>
                  {cartProducts.map((cartProduct) => (
                    <tr key={cartProduct.id}>
                      ...
                      <td>
                        <p className="mb-0 mt-4">{cartProduct.price} LKR</p>
                      </td>
                      <td>
                        <div
                ...
                <div className="bg-light rounded">
                  <div className="p-4">
                    ...
                    <div className="d-flex justify-content-between mb-4">
                      ...
                      <p className="mb-0">LKR{totalAmount}</p>
                    </div>
                    <div className="d-flex justify-content-between">
                      <h5 className="mb-0 me-4">Shipping</h5>
                      <div>
                        <p className="mb-0">Flat rate: LKR {deliverCharge}</p>
                      </div>
                    </div>
                  </div>
